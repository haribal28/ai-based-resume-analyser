...
def get_match_score():
    ...
    hr_keywords = job.get("hr_keywords", []) or []

    match_score     = compute_match_score(resume_text, job_desc, hr_keywords)
    skills_analysis = identify_missing_skills(resume_text, job_desc, hr_keywords)
